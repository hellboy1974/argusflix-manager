...
\33[33mNumber of """ +str(say)+""" combo files
 ...
 Enter the Number of Macs to Scan.
...
botsay=input("""
   ...
   \33[1;96mBOT!\33[0m
    \33[1;33mChoose number of Bots - Use 1 to 21 !!\33[0m
...
Dosyab="/sdcard/Hits/FASTX2PY/" +panel.replace(":","_").replace('/','') +".txt"
say=1  
def yax(hits):
...
def echok(mac,bot,total,hitc,oran,tokenr):
	...
	try:
		...
		if str(cpmx)=="0":
			...
			cpm=cpmx
		echo=(""""""+str(hitr)+"""🕳️🧿🕳️>""" +str(hitc)+"""   \33[0m""" +tokenr+str(mac)+""" \33[0m \33[36m"""  +str(total)+""" \33[0m """)
		print(echo)
		cpm=time.time()
	except:pass
...
def hitprint(mac,trh):
	sesdosya="/sdcard/sounds/ching.mp3"
