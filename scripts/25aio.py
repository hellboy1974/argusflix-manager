...
if bekleme=="":
	...
	bekleme=int(bekleme)
try:
	if panel.split('/')[7] =='stalker_portal':
		uzmanm="stalker_portal/server/load.php"
...
botsay=input("""
   ...
   \33[1;96mBOT!\33[0m
    \33[1;33mChoose number of Bots - Use 1 to 25 !!\33[0m
...
Dosyab="/sdcard/hits/"+panel.replace(":","_").replace('/','')+"25🅰🅸🅾.txt"
say=1
...
def hit(mac,trh,real,m3ulink,durum,vpn,livelist,vodlist,serieslist,playerapi,SN,SNENC,SNCUT,DEV,DEVENC,SG,SING,SINGENC,kanalsayisi,filmsayisi,dizisayisi):
 ...
 █▓▒░░25AIO░░▒▓█	
├👁️‍🗨️Real ➤ """+str(real)+""""""+str(uzmanm2)+""""""+str(buri)+"""
├👁️‍🗨Panel ➤ http://"""+str(panel)+""""""+str(urib)+""""""+str(uzmanm2)+""""""+str(buri)+"""
├👁️‍🗨Mac ➤ """+str(mac)+"""
├👁️‍🗨🔸SN:"""+SNENC+"""
├👁️‍🗨🔸SNCUT:"""+SNCUT+"""
├─👁️‍🗨️🔸🚦 Device ID1:
...
├👁️‍🗨️"""+SINGENC+"""
├👁️‍🗨️Exp ➤ """+str(trh)+"""
├👁️‍🗨️Type/Scan date ➤ """+uzmanm+"""/"""+str(time.strftime("%Y:%m:%d"))+"""
├👁️‍🗨️Image ➤ """+str(durum)+"""
├👁️‍🗨Vpn ➤ """+str(vpn)+""""""+str(playerapi)+"""
╭─👁️‍🗨️ 𝗛𝗶𝘁𝘀 ʙʏ """+str(nickn)+"""     
╰─👁️‍🗨️m3uLink ➤ """+str(m3ulink)+"""
"""
		if len(kanalsayisi) > 1:
			imza=imza+"""╭─👁️‍🗨️ Channels ➤"""+str(kanalsayisi)+"""
├👁️‍🗨 Vod ➤"""+str(filmsayisi)+"""
╰─👁️‍🗨️ Series ➤"""+str(dizisayisi)+"""
"""
...
def echok(mac,bot,total,hitc,oran,tokenr):
	...
	#global cpmx
		...
		if str(cpmx)=="0":
			...
			cpm=cpmx
		echo=("""
╭─➤m\33[1;7m ➤ """+str(panel)+"""  \33[0m  \33[0m\33[94mCPM➤"""+str(cpm)+"""  \33[0m 
╰─● """+tokenr+str(mac)+""" \33[1;32m"""  +str(bot)+""" \33[36m\33[0m """+str(hitr)+"""Hit➤""" +str(hitc)+"""  \33[0m\33[1;31m%"""+str(oran)+"""  \33[0m""")                                                        
		print(echo)
		cpm=time.time()
	except:pass
...
def hitprint(mac,trh):
	#playsound('/sdcard/sounds/hit.mp3')
	file = pathlib.Path()
	try:
		if file.exists():
		    ad.mediaPlay()
...
def m3uapi(playerlink,macs,token):
	...
	try:
			...
			if 'active_cons' in veri:
				...
				mt=("""
╭─👁️‍🗨️🌐Host ➤ http://"""+panel+""""""+str(uzmanm2)+""""""+str(buri)+"""    
├️‍👁️‍🗨️🌍Real ➤ http://"""+realm+""":"""+port+""""""+str(uzmanm2)+""""""+str(buri)+"""
├️‍👁️‍🗨️📡Port ➤ """+port+"""
├️‍‍👁️‍🗨️👩‍User ➤ """+userm+"""
├️‍👁️‍🗨️🔑Pass ➤ """+pasm+"""
├─👁️‍🗨️📆Exp ➤ """+bitism+""" 
...
if botsay==16 or botsay==17 or botsay==18 or botsay==19 or botsay==20 or botsay==21 or botsay==22 or botsay==23 or botsay==24 or botsay==25:
	t16.start()
	
	
if botsay==17 or botsay==18 or botsay==19 or botsay==20 or botsay==21 or botsay==22 or botsay==23 or botsay==24 or botsay==25:
	t17.start()
	
	
if botsay==18 or botsay==19 or botsay==20 or botsay==21 or botsay==22 or botsay==23 or botsay==24 or botsay==25:
	t18.start()
	
	
if botsay==19 or botsay==20 or botsay==21 or botsay==22 or botsay==23 or botsay==24 or botsay==25:
	t19.start()
	
	
if botsay==20 or botsay==21 or botsay==22 or botsay==23 or botsay==24 or botsay==25:
	t20.start()
	
	
if botsay==21 or botsay==22 or botsay==23 or botsay==24 or botsay==25:
	t21.start()
	

if botsay==22 or botsay==23 or botsay==24 or botsay==25:
	t22.start()
	
	
if botsay==23 or botsay==24 or botsay==25:
	t23.start()
	
	
if botsay==24 or botsay==25:
	t24.start()
