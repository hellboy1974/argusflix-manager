...
feyzo=("""                                   
 ...
 𝕄𝕠𝕕𝕕𝕖𝕕 𝕓𝕪 𝔸𝕡𝕠𝕔𝕒𝕝𝕪𝕡𝕤𝕖
 𝕆𝕣𝕚𝕘𝕚𝕟𝕒𝕝 ℂ𝕣𝕖𝕕𝕚𝕥 𝔾𝕠𝕖𝕤 𝕋𝕠 🅵🅴🆈🆉🅾️
                                                                             """)
print(feyzo)
...
intro="""
 ...
 12 ➨ Link_OK/portal.php
 13 ➨ k/portal.php
 14 ➨ NXT/portal.php
 15 ➨ powerfull/portal.php
 16 ➨ cp/server/load.php
 17 ➨ korisnici/server/load.php
 18 ➨ tek/server/load.php
 19 ➨ emu/server/load.php
 20 ➨ emu2/server/load.php
 21 ➨ ghandi_portal/server/load.php

\33[1;44m
Select 1 to 21 for portal type = \33[0m\33[31m\33[1;37;41m"""
...
Dosyab="/sdcard/hits/Apoc-mac_" +panel.replace(":","_").replace('/','') +" 🅰🅿⭕️🅲🅰️🅻🆈🅿️🆂🅴.txt"
say=1
def yax(hits):
    dosya=open(Dosyab,'a+') 
    dosya.write(hits)
