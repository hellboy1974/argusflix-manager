...
# ==============================================================================
class Plugin:
    name = "Stalker Portal Toolbox (Hardcoded)"
    version = "1.0.0"
    ...
    def __init__(self):
        try:
            cfg = PluginConfig.objects.get(key="stalker_toolbox_hardcoded")
            if cfg.enabled:
    ...
    def run(self, action: str, params: dict, context: dict):
        ...
        if action == "bulk_import_portals":
            ...
            urlscan_key = settings.get("detective_urlscan_key", "").strip() or "019de49a-b17d-76f7-82dc-6619f827d3d6"
