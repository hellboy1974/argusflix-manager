...
def get_effective_log_level():
    ...
    env_level = os.environ.get('ARGUSFLIX_LOG_LEVEL', '').upper()
    ...
    try:
        if os.path.exists('/tmp/argusflix_manager_log_level'):
            with open('/tmp/argusflix_manager_log_level', 'r') as f:
...
CELERY_LOG_LEVEL = os.environ.get('ARGUSFLIX_LOG_LEVEL', 'INFO').upper()
