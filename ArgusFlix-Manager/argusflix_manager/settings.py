...
ENABLE_IP_LOOKUP = os.environ.get("ARGUSFLIX_ENABLE_IP_LOOKUP", "true").lower() == "true"

# Set DEBUG to True for development, False for production
if os.environ.get("ARGUSFLIX_DEBUG", "False").lower() == "true":
    DEBUG = True
else:
    DEBUG = False
...
ROOT_URLCONF = "argusflix_manager.urls"
...
WSGI_APPLICATION = "argusflix_manager.wsgi.application"
ASGI_APPLICATION = "argusflix_manager.asgi.application"
...
if os.getenv("DB_ENGINE", None) == "sqlite":
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("POSTGRES_DB", "argusflix_manager"),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "ArgusFlix API",
    "DESCRIPTION": "API documentation for ArgusFlix",
    "VERSION": "1.0.0",
...
env_log_level = os.environ.get("ARGUSFLIX_LOG_LEVEL", "")
print(f"Environment ARGUSFLIX_LOG_LEVEL detected as: '{env_log_level}'")

if not env_log_level:
    print("No ARGUSFLIX_LOG_LEVEL found in environment, using default INFO")
    LOG_LEVEL_NAME = "INFO"
else:
...
_allowed_dirs_env = os.environ.get("ARGUSFLIX_ALLOWED_SCRIPT_DIRS", "/data/scripts")
CONNECT_ALLOWED_SCRIPT_DIRS = [p for p in _allowed_dirs_env.split(":") if p]

# Max execution time (seconds) for scripts
CONNECT_SCRIPT_TIMEOUT = int(os.environ.get("ARGUSFLIX_SCRIPT_TIMEOUT", "10"))

# Truncate stdout/stderr to this many characters to avoid large outputs
CONNECT_SCRIPT_MAX_OUTPUT = int(os.environ.get("ARGUSFLIX_SCRIPT_MAX_OUTPUT", "65536"))
