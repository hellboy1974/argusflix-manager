# Contributing to ArgusFlix

Thank you for your interest in contributing. ArgusFlix is a complex, production-oriented platform and we hold contributions to a high standard. Please read this guide in full before opening a pull request — it will save everyone time.
...
| `ARGUSFLIX_DEBUG`     | Enables Django debug mode **and** starts debugpy for remote debugging (attach on port 5678) |
| `ARGUSFLIX_LOG_LEVEL` | Log verbosity                                                                               |
...
- You grant the ArgusFlix project a perpetual, worldwide, irrevocable, royalty-free license to use, reproduce, modify, distribute, sublicense, and relicense your contribution as part of this project, under any license the project maintainers choose, now or in the future.
