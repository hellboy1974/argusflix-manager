...
export default function PluginBrowsePage() {
  ...
  const filteredPlugins = React.useMemo(() => {
    ...
    if (filterStatus === 'installed') {
      ...
      list = list.filter((p) => {
        const meetsMin =
          !p.min_argusflix_manager_version ||
          compareVersions(appVersion, p.min_argusflix_manager_version) >= 0;
        const meetsMax =
          !p.max_argusflix_manager_version ||
          compareVersions(appVersion, p.max_argusflix_manager_version) <= 0;
      ...
      <Group justify="space-between" mb="md">
        ...
        <Group>
          <Button
            ...
            color="teal"
            component="a"
            href="https://github.com/ArgusFlix/Plugins?tab=contributing-ov-file"
            target="_blank"
              ...
              >
                {previewLoading ? (
                  ...
                  <Text size="xs" c="yellow">
                    Third-party repositories are not reviewed by the ArgusFlix
                    team.
                    <br />
