...
export const usePluginStore = create((set, get) => ({
  ...
  installPlugin: async ({ repo_id, slug, version, download_url, sha256, min_argusflix_manager_version, max_argusflix_manager_version, prerelease }) => {
    const result = await API.installPluginFromRepo({
      ...
      download_url,
      sha256,
      min_argusflix_manager_version,
      max_argusflix_manager_version,
