...
const PluginDetailPanel = ({
  ...
  const selMeetsMin =
    !selectedVersionData?.min_argusflix_manager_version ||
    compareVersions(appVersion, selectedVersionData.min_argusflix_manager_version) >=
      0;
  const selMeetsMax =
    !selectedVersionData?.max_argusflix_manager_version ||
    compareVersions(appVersion, selectedVersionData.max_argusflix_manager_version) <=
      0;
  ...
  const handleInstallClick = () => {
    ...
    const params = {
      ...
      min_argusflix_manager_version: selectedVersionData.min_argusflix_manager_version,
      max_argusflix_manager_version: selectedVersionData.max_argusflix_manager_version,
    ...
    <Stack gap="md">
      ...
      {manifest.deprecated && (
        ...
        >
          ...
          versions of ArgusFlix. Consider looking for an alternative.
        </Alert>
      )}
                ...
                <Group gap="xs" align="center">
                  ...
                  {!selCompatible &&
                    ...
                    (() => {
                      ...
                      if (!selMeetsMin)
                        parts.push(
                          `${selectedVersionData.min_argusflix_manager_version} or newer`
                        );
                      if (!selMeetsMax)
                        parts.push(
                          `${selectedVersionData.max_argusflix_manager_version} or older`
                        );
                      const label = !selMeetsMin
                        ? `Min ${selectedVersionData.min_argusflix_manager_version}`
                        : `Max ${selectedVersionData.max_argusflix_manager_version}`;
                      return (
                        <Tooltip
