...
const RedisStatus = ({ tls }) => {
  ...
  return (
    <TlsServiceCard serviceName="Redis">
      <TlsOption
        label="Encryption"
        description="Encrypt traffic between ArgusFlix and Redis."
        tooltip={
          enabled
      ...
      <TlsOption
        label="Mutual TLS"
        description="Authenticate ArgusFlix to Redis using a client certificate."
        tooltip={mtlsTooltip}
...
const PostgresStatus = ({ tls }) => {
  ...
  return (
    <TlsServiceCard serviceName="PostgreSQL">
      <TlsOption
        label="Encryption"
        description="Encrypt traffic between ArgusFlix and PostgreSQL."
        tooltip={
          enabled
            ? 'The connection is encrypted'
            : 'The connection is not encrypted'
      ...
      <TlsOption
        label="Mutual TLS"
        description="Authenticate ArgusFlix to PostgreSQL using a client certificate."
        tooltip={mtlsTooltip}
        badgeText={mtls && enabled ? 'Active' : 'Inactive'}
        badgeColor={mtlsColor}
      />
