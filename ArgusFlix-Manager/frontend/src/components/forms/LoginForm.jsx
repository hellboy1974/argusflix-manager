...
const LoginForm = () => {
  ...
  useEffect(() => {
    ...
    const savedUsername = localStorage.getItem(
      'argusflix_manager_remembered_username'
    );
    const savedPassword = localStorage.getItem('argusflix_manager_saved_password');
    ...
    try {
      ...
      if (rememberMe) {
        ...
        if (savePassword) {
          ...
          if (encoded) {
            localStorage.setItem('argusflix_manager_saved_password', encoded);
          }
        } else {
          localStorage.removeItem('argusflix_manager_saved_password');
        }
      } else {
        localStorage.removeItem('argusflix_manager_remembered_username');
        localStorage.removeItem('argusflix_manager_saved_password');
      }
