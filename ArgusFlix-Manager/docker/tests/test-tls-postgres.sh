...
# Validates that ArgusFlix connects correctly to external PostgreSQL and
...
#
# Options:
#   --skip-build    Skip Docker image build (use existing argusflix_manager:tls-test image)
...
# Configuration
###############################################################################
IMAGE_NAME="argusflix_manager:tls-test"
...
test_modular_full_tls_celery() {
    ...
    docker run -d --name "$celery_name" --network "$net" \
        "${tls_env[@]}" \
        -e DJANGO_SETTINGS_MODULE=argusflix_manager.settings \
...
###############################################################################
echo -e "${BOLD}╔═══════════════════════════════════════════════════════════╗${NC}"
echo -e "${BOLD}║   ArgusFlix — TLS Integration Tests                    ║${NC}"
echo -e "${BOLD}╚═══════════════════════════════════════════════════════════╝${NC}"
