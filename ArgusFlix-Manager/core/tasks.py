...
def check_for_version_update():
    """
    Check for new ArgusFlix versions on GitHub and create a notification if available.
    ...
    try:
        ...
        ARGUSFLIX_HEADERS = {'User-Agent': f'ArgusFlix/{__version__}'}

        if is_dev_build:
            # Check Docker Hub for newer dev builds
            docker_hub_url = "https://hub.docker.com/v2/repositories/argusflix_manager/argusflix_manager/tags/dev"

            response = requests.get(docker_hub_url, headers=ARGUSFLIX_HEADERS, timeout=10)
                ...
                notification, created = SystemNotification.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        'action_data': {
                            ...
                            'update_url': 'https://hub.docker.com/r/argusflix_manager/argusflix_manager/tags'
                        },
                        'is_active': True,
                        'admin_only': True,
                    }
            ...
            github_api_url = "https://api.github.com/repos/ArgusFlix/ArgusFlix/releases/latest"
            headers = {"Accept": "application/vnd.github.v3+json", **ARGUSFLIX_HEADERS}
            ...
            if latest > current:
                ...
                logger.debug(f"ArgusFlix is up to date (v{__version__})")
