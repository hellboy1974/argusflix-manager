...
from argusflix_manager.utils import get_client_ip
...
_IP_CACHE_KEY = "argusflix_manager:ip_lookup_result"
_IP_CACHE_TTL = 3600  # 1 hour
_IP_LOCK_KEY = "argusflix_manager:ip_lookup_lock"
    ...
    return Response(
        {
            ...
            "env_mode": os.getenv("ARGUSFLIX_ENV", "aio"),
            "redis_tls": {
