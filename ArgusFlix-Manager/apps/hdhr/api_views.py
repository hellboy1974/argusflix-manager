...
class DiscoverAPIView(APIView):
    ...
    def get(self, request, channel_profile=None, output_profile_id=None):
        ...
        device_ID = f"argusflix_manager-hdhr-{'-'.join(slug_parts)}" if slug_parts else "12345678"
        friendly_name = f"ArgusFlix HDHomeRun - {' / '.join(slug_parts)}" if slug_parts else "ArgusFlix HDHomeRun"
...
class HDHRDeviceXMLAPIView(APIView):
    ...
    def get(self, request):
        ...
        <root>
            ...
            <FriendlyName>ArgusFlix HDHomeRun</FriendlyName>
