...
def fetch_schedules_direct(source, stations_only=False, force=False):
    ...
    # SergeantPanda confirmed ArgusFlix should identify itself properly.
    # -------------------------------------------------------------------------
    from version import __version__ as argusflix_manager_version
    sd_user_agent = f"ArgusFlix/{argusflix_manager_version}"
    ...
    try:
        ...
        if auth_code != 0:
            if auth_code == 4007:
                msg = "Schedules Direct: this application is not authorized. Please contact the ArgusFlix maintainers."
            elif auth_code == 4004:
