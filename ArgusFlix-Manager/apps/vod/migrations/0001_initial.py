...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('argusflix_manager_channels', '0024_alter_channelgroupm3uaccount_channel_group'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movie', to='argusflix_manager_channels.logo')),
            ],
            options={
                'verbose_name': 'Movie',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('logo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='series', to='argusflix_manager_channels.logo')),
            ],
            options={
                'verbose_name': 'Series',
