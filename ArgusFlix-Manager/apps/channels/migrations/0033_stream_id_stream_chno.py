...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('argusflix_manager_channels', '0032_channel_is_adult_stream_is_adult'),
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='stream',
            index=models.Index(fields=['stream_id'], name='argusflix_manager_stream_id_idx'),
        ),
        migrations.AddIndex(
            model_name='stream',
            index=models.Index(fields=['stream_chno'], name='argusflix_manager_stream_chno_idx'),
        ),
    ]
