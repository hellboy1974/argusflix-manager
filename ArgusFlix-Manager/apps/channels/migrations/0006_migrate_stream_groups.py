...
def migrate_channel_group(apps, schema_editor):
    Stream = apps.get_model('argusflix_manager_channels', 'Stream')
    ChannelGroup = apps.get_model('argusflix_manager_channels', 'ChannelGroup')
    ChannelGroupM3UAccount = apps.get_model('argusflix_manager_channels', 'ChannelGroup')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('argusflix_manager_channels', '0005_stream_channel_group_stream_last_seen_and_more'),
    ]
