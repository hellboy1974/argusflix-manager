    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel_group', models.ForeignKey(blank=True, help_text='Channel group this channel belongs to.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='channels', to='argusflix_manager_channels.channelgroup')),
            ],
        ),
        migrations.CreateModel(
            name='Stream',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='argusflix_manager_channels.channel')),
                ('stream', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='argusflix_manager_channels.stream')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.AddField(
            model_name='channel',
            name='streams',
            field=models.ManyToManyField(blank=True, related_name='channels', through='argusflix_manager_channels.ChannelStream', to='argusflix_manager_channels.stream'),
        ),
    ]
