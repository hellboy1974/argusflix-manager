...
def epg_endpoint(request, profile_name=None, user=None):
    ...
    if request.method == "HEAD":
        ...
        response["Content-Disposition"] = 'attachment; filename="ArgusFlix.xml"'
...
def generate_epg(request, profile_name=None, user=None):
    ...
    def epg_generator():
        ...
        xml_lines.append(
            '<tv generator-info-name="ArgusFlix" generator-info-url="https://github.com/ArgusFlix/ArgusFlix">'
        )
