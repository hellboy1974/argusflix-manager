...
def drop_constraints_pg(apps, schema_editor):
    """
    Remove foreign key constraints temporarily on PostgreSQL.
    Bypassed on SQLite/other databases.
    """
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(drop_constraints_pg, migrations.RunPython.noop),
