...
urlpatterns = [
    ...
    # Plugin UI static files serving
    path("plugins/<str:key>/ui/", PluginUIStaticAPIView.as_view(), kwargs={"path": "index.html"}, name="ui-root"),
    path("plugins/<str:key>/ui/<path:path>", PluginUIStaticAPIView.as_view(), name="ui-static"),
]
